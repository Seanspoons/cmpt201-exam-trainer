...
export const UNIT_OPTIONS: UnitOption[] = [
  ...
  { id: 'networking-sockets', label: 'Networking: Sockets', implemented: false },
  { id: 'networking-af-inet', label: 'Networking: AF_INET', implemented: false },
  { id: 'networking-multiple-clients', label: 'Networking: Multiple Clients', implemented: false },
